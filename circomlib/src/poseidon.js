...
const bigInt = require("big-integer"); // TODO Remove this after testing
...
// TODO: Undo this change after testing
const { pedersen, computeHashOnElements } = require("starknet/utils/hash");

function poseidon(arr) {
  if (arr.length > 2) {
    return BigInt(computeHashOnElements(arr), 16);
  } else {
    return BigInt(pedersen(arr), 16);
  }
}
