...
func verify_deposit_notes{
    ...
    # ? Sum the notes and verify that the signature is correct
    ...
    let (deposit_hash : felt) = deposit_tx_hash(note_hashes_len, note_hashes)
...
func deposit_tx_hash{pedersen_ptr : HashBuiltin*}(note_hashes_len : felt, note_hashes : felt*) -> (
    res
):
    alloc_locals
