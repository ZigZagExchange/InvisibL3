...
const fs = require("fs");
const Tree = require("../src/tree2");
const Account = require("../src/account2.js");
const AccountTree = require("../src/accountTree.js");
const Transaction = require("../src/transaction2.js");
const TxTree = require("../src/txTree2.js");
const treeHelper = require("../src/treeHelper2.js");
const getCircuitInput = require("../src/circuitInput2.js");
const {
  stringifyBigInts,
  unstringifyBigInts,
} = require("../src/stringifybigint2.js");
...
const first4SubtreeProof = zeroCache
  .slice(1, BAL_DEPTH - Math.log2(4) + 1)
  .reverse();
console.log("first4SubtreeProof", first4SubtreeProof);
const rootAfterFirstDeposit = treeHelper.rootFromLeafAndPath(
  first4SubtreeRoot,
  0,
  first4SubtreeProof
);
...
//     treeHelper.rootFromLeafAndPath(
//       zeroCache[BAL_DEPTH - Math.log2(4)],
//       0,
//       first4SubtreeProof
//     )
// );
...
// //     )
// // );
// // console.log("new root after second deposit", rootAfterSecondDeposit);

// const paddedAccounts2 = treeHelper.padArray(accounts, zeroAccount, numLeaves);
